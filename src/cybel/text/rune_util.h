...
namespace RuneUtil {
  inline constexpr char32_t kInvalidRune = U'�'; /// \uFFFD.
  inline const auto* kInvalidPackedRune = "�"; /// \xEF\xBF\xBD.

  inline constexpr octet_t kMaxAsciiOctet = 0x7F; /// 0b0111'1111.
  inline constexpr octet_t kMinTailOctet = 0x80; /// 0b1000'0000.
  inline constexpr octet_t kMaxTailOctet = 0xBF; /// 0b1011'1111.
  inline constexpr octet_t kTailOctetMask = 0b0011'1111; /// 0b10xxxxxx.
